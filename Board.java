 ...
 */
 ...
 class Board
 {
   ...
   /*
    * The constructor is simple and just initiates the array with zeroes.
   ...
   /* The methods below are for the current purpose of this class, which is
    * mostly mathematical, and might (and most likely will) be removed on
    * future commits.
    *
    ...
    */
    ...
    /*
     * This method considers the array as a base-3 number and increases it by 1.
     */
    void increase()
    {
    ...
    /*
     * This method checks if the array reached its maximum value, 222 222 222.
     *
